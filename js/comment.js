    ...
    JL.Renders = {
        box: {
            tpl: [
                ...
                '<div class="com-avatar"><img id="JELON__loginAvatar" src="https://gitee.com/sunjinchao/cloudfile_C01/raw/master/img/20190808221124.jpg" alt="avatar"></div>',
                '<div class="com-text">',
                '<div class="main">',
            ...
            update: function() {
                ...
                $('JELON__loginAvatar').src = userInfo.avatar_url || 'https://gitee.com/sunjinchao/cloudfile_C01/raw/master/img/20190808221124.jpg';
            }
        },
        list: {
            tpl: [
